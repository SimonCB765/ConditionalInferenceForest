 ...
 *
 */
public class NonTerminalCategoricalRegressionNode extends Node
{
	...
	public NonTerminalCategoricalRegressionNode(String loadString)
	{
	...
	public NonTerminalCategoricalRegressionNode(int nodeDepth, String covariable, double[] splitValue,
			List<Node> children, Map<String, double[]> testStatsAndPVals, int numberOfObservationsInNode)
	{

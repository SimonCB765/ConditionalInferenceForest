 ...
 *
 */
public class NonTerminalNumericClassificationNode extends NodeClassification
{
	...
	public NonTerminalNumericClassificationNode(String loadString)
	{
	...
	public NonTerminalNumericClassificationNode(int nodeDepth, String covariable, double splitValue,
			Node leftChild, Node rightChild, Map<String, Integer> classCountsInNode,
			Map<String, double[]> testStatsAndPVals)
	{
